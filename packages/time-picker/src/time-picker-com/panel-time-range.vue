<template>
  <div v-if="actualVisible" class="ur-time-range-picker ur-picker-panel">
    <div class="ur-time-range-picker__content">
      <div class="ur-time-range-picker__cell">
        <div class="ur-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
        <div
      ...
      <div class="ur-time-range-picker__cell">
        <div class="ur-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
          class="ur-time-range-picker__body ur-time-panel__content"
        >
