<template>
  <ur-menu-collapse-transition v-if="props.collapseTransition">
    <ul
      :key="+props.collapse"
      role="menubar"
      ...
      :class="{
        'ur-menu': true,
        'ur-menu--horizontal': mode === 'horizontal',
        'ur-menu--collapse': props.collapse,
      }"
    >
      <slot></slot>
    </ul>
  </ur-menu-collapse-transition>
  <ul
    v-else
    :key="+props.collapse"
    role="menubar"
...
import UrMenuCollapseTransition from './menu-collapse-transition.vue'
import useMenuColor from './useMenuColor'

export default defineComponent({
  name: 'UrMenu',
  componentName: 'UrMenu',
  components: {
    UrMenuCollapseTransition,
  },
  props: {
    mode: {
      type: String,
