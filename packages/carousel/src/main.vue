<template>
  ...
  >
    <div v-if="arrowDisplay" class="carousel-control-prev">
      <button
        v-show="
    ...
    <div v-if="arrowDisplay" class="carousel-control-next">
      <button
        v-show="
          (arrow === 'always' || data.hover) &&
...
export default defineComponent({
  ...
  setup(props: ICarouselProps, { emit }) {
    ...
    const carouselClasses = computed(() => {
      const classes = ['ur-carousel', 'ur-carousel--' + props.direction]
      if (props.type === 'card') {
        classes.push('ur-carousel--card')
      }
      return classes
    })
    ...
    const indicatorsClasses = computed(() => {
      const classes = [
        'ur-carousel__indicators',
        'ur-carousel__indicators--' + props.direction,
      ]
      if (hasLabel.value) {
        classes.push('ur-carousel__indicators--labels')
      }
      if (props.indicatorPosition === 'outside' || props.type === 'card') {
        classes.push('ur-carousel__indicators--outside')
      }
      return classes
    })
