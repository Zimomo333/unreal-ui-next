...
export interface UrMessageBoxOptions {
...
export type UrMessageBoxShortcutMethod =
  ((
      message: string,
      title: string,
...
export interface UrMessageBox {
  /** Show a message box */
  // (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: UrMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: UrMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: UrMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: UrMessageBoxShortcutMethod
