<template>
  <div
    class="ur-picker-panel ur-date-range-picker"
    :class="[{
  ...
  >
    <div class="ur-picker-panel__body-wrapper">
      ...
      <div class="ur-picker-panel__body">
        <div v-if="showTime" class="ur-date-range-picker__time-header">
          <span class="ur-date-range-picker__editors-wrap">
            <span class="ur-date-range-picker__time-picker-wrap">
              <ur-input
                size="small"
                :disabled="rangeState.selecting"
                :placeholder="t('el.datepicker.startDate')"
                class="ur-date-range-picker__editor"
                :model-value="minVisibleDate"
                @input="val => handleDateInput(val, 'min')"
                @change="val => handleDateChange(val, 'min')"
              />
            </span>
            <span v-clickoutside="handleMinTimeClose" class="ur-date-range-picker__time-picker-wrap">
              <ur-input
                size="small"
                class="ur-date-range-picker__editor"
                :disabled="rangeState.selecting"
          ...
          <span class="ur-icon-arrow-right"></span>
          <span class="ur-date-range-picker__editors-wrap is-right">
            <span class="ur-date-range-picker__time-picker-wrap">
              <ur-input
                size="small"
                class="ur-date-range-picker__editor"
            ...
            <span v-clickoutside="handleMaxTimeClose" class="ur-date-range-picker__time-picker-wrap">
              <ur-input
                size="small"
                class="ur-date-range-picker__editor"
                :disabled="rangeState.selecting"
        ...
        <div class="ur-picker-panel__content ur-date-range-picker__content is-left">
          <div class="ur-date-range-picker__header">
            <button
              type="button"
              class="ur-picker-panel__icon-btn ur-icon-d-arrow-left"
              @click="leftPrevYear"
            ></button>
            <button
              type="button"
              class="ur-picker-panel__icon-btn ur-icon-arrow-left"
              @click="leftPrevMonth"
            ></button>
            <button
              v-if="unlinkPanels"
              ...
              class="ur-picker-panel__icon-btn ur-icon-d-arrow-right"
              @click="leftNextYear"
            ></button>
            <button
              v-if="unlinkPanels"
              ...
              class="ur-picker-panel__icon-btn ur-icon-arrow-right"
              @click="leftNextMonth"
            ></button>
            <div>{{ leftLabel }}</div>
          </div>
        ...
        <div class="ur-picker-panel__content ur-date-range-picker__content is-right">
          <div class="ur-date-range-picker__header">
            <button
              v-if="unlinkPanels"
              type="button"
    ...
    <div v-if="showTime" class="ur-picker-panel__footer">
      <ur-button
        size="mini"
        type="text"
...
import { TimePickPanel } from '@/packages/time-picker'
...
export default defineComponent({
  ...
  components: { TimePickPanel, DateTable, UrInput, UrButton },
