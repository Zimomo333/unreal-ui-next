...
export default defineComponent({
  ...
  render() {
    ...
    const rightWrapperRoot = h('div', { class: 'ur-pagination__rightwrapper' }, rightWrapperChildren)
    const TEMPLATE_MAP = {
      prev: h(Prev, {
    ...
    const wrapNode = h('div', {
      class: 'ur-pagination-wrap',
    }, h(rootNode, {}, rootChildren))
