...
import { defaultProps } from '@/packages/popper'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    if (props.manual && typeof props.modelValue === 'undefined') {
      throwError('[UrTooltip]', 'You need to pass a v-model to ur-tooltip when `manual` is true')
    }
  ...
  render() {
    ...
    const throwErrorTip = () => {
      throwError('[UrTooltip]', 'you need to provide a valid default slot.')
    }
