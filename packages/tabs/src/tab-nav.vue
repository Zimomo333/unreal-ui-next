...
export default defineComponent({
  ...
  setup() {
    ...
    if (!rootTabs) {
      throw new Error(`UrTabNav must use with UrTabs`)
    }
  ...
  render() {
    ...
    const scrollBtn = scrollable ? [
      h(
        'span',
        {
          class: ['ur-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled'],
          onClick: scrollPrev,
        },
        [h('i', { class: 'ur-icon-arrow-left' })],
      ),
      h(
        'span',
        {
          class: ['ur-tabs__nav-next', scrollable.next ? '' : 'is-disabled'],
          onClick: scrollNext,
        },
        [h('i', { class: 'ur-icon-arrow-right' })],
      ),
    ] : null
    ...
    return h(
      ...
      {
        ref: 'el$',
        class: ['ur-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${ rootTabs.props.tabPosition }`],
      },
      [
        scrollBtn,
        h(
          ...
          [
            h(
              'div',
              {
                class: ['ur-tabs__nav', `is-${ rootTabs.props.tabPosition }`, stretch && ['top', 'bottom'].includes(rootTabs.props.tabPosition) ? 'is-stretch' : ''],
                ref: 'nav$',
                style: navStyle,
                role: 'tablist',
                onKeydown: changeTab,
