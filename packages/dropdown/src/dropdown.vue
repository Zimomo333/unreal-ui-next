<template>
  <ur-popper
    ...
    :manual-mode="true"
    :trigger="[trigger]"
    popper-class="ur-dropdown__popper"
    append-to-body
  ...
  >
    <template #default>
      <ur-scrollbar
        ...
        view-class="ur-dropdown__list"
      >
        <slot name="dropdown"></slot>
      </ur-scrollbar>
    </template>
    <template #trigger>
      <div :class="['ur-dropdown', dropdownSize ? 'ur-dropdown--' + dropdownSize : '']">
        ...
        <template v-else>
          ...
          <ur-button
            :size="dropdownSize"
            :type="type"
            class="ur-dropdown__caret-button"
          >
            <i class="ur-dropdown__icon ur-icon-arrow-down"></i>
          </ur-button>
        </template>
      </div>
    </template>
