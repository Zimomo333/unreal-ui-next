import { PopperInstance, IPopperOptions } from '@/packages/popper'
...
export const getColumnByCell = function(
  ...
  const matches = (cell.className || '').match(/ur-table_[^\s]+/gm)
  if (matches) {
...
export function createTablePopper(
  ...
  function renderContent(): HTMLDivElement {
    ...
    content.className = `ur-popper ${isLight ? 'is-light' : 'is-dark'}`
  ...
  function renderArrow(): HTMLDivElement {
    ...
    arrow.className = 'ur-popper__arrow'
