<template>
  <div
    :class="[
      {
        'ur-table--fit': fit,
        'ur-table--striped': stripe,
        'ur-table--border': border || isGroup,
        'ur-table--hidden': isHidden,
        'ur-table--group': isGroup,
        'ur-table--fluid-height': maxHeight,
        'ur-table--scrollable-x': layout.scrollX.value,
        'ur-table--scrollable-y': layout.scrollY.value,
        'ur-table--enable-row-hover': !store.states.isComplex.value,
        'ur-table--enable-row-transition':
          (store.states.data.value || []).length !== 0 &&
          (store.states.data.value || []).length < 100,
      },
      tableSize ? `ur-table--${tableSize}` : '',
    ]"
    class="ur-table"
  ...
  >
    ...
    <div
      ...
      class="ur-table__header-wrapper"
    >
      <table-header
        ref="tableHeader"
        :border="border"
    ...
    <div ref="bodyWrapper" :style="[bodyHeight]" class="ur-table__body-wrapper">
      <table-body
        :context="context"
      ...
      <div
        ...
        class="ur-table__empty-block"
      >
        <span class="ur-table__empty-text">
      ...
      <div
        v-if="$slots.append"
        ref="appendWrapper"
        class="ur-table__append-wrapper"
      >
    ...
    <div
      ...
      ref="footerWrapper"
      v-mousewheel="handleHeaderFooterMousewheel"
      class="ur-table__footer-wrapper"
    >
      <table-footer
        :border="border"
        :default-sort="defaultSort"
    ...
    <div
      ...
      class="ur-table__fixed"
    >
      <div
        v-if="showHeader"
        ref="fixedHeaderWrapper"
        class="ur-table__fixed-header-wrapper"
      >
        <table-header
      ...
      <div
        ...
        class="ur-table__fixed-body-wrapper"
      >
        <table-body
          :highlight="highlightCurrentRow"
          :row-class-name="rowClassName"
      ...
      <div
        ...
        class="ur-table__fixed-footer-wrapper"
      >
        <table-footer
          :border="border"
          :store="store"
    ...
    <div
      ...
      class="ur-table__fixed-right-patch"
    ></div>
    <div
      v-show="resizeProxyVisible"
      ref="resizeProxy"
      class="ur-table__column-resize-proxy"
    ></div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props: TableProps) {
    ...
    const tableId = 'ur-table_' + tableIdSeed++
