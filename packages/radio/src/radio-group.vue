...
import { urFormItemKey } from '@/packages/form'
import radioGroupKey from './token'

import type { PropType } from 'vue'
import type { UrFormItemContext } from '@/packages/form'

export default defineComponent({
  name: 'UrRadioGroup',

  componentName: 'UrRadioGroup',
  ...
  setup(props, ctx) {
    ...
    const radioGroupSize = computed<ComponentSize>(() => {
      return props.size || urFormItem.size
    })
